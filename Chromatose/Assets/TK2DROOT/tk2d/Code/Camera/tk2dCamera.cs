...
public class tk2dCamera : MonoBehaviour 
{
	...
	void OnDrawGizmos(){
		...
		Gizmos.DrawWireCube(transform.position + new Vector3(nativeResolutionWidth, nativeResolutionHeight, 0)/2, 
										new Vector3(nativeResolutionWidth, nativeResolutionHeight, 50));
