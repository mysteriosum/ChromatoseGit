...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipEntry : ICloneable
	{
		...
		public bool LocalHeaderRequiresZip64 
		{
			get {
				...
				if ( !result ) {
					...
					// A better estimation of the true limit based on compression overhead should be used
		...
		public byte[] ExtraData {
			...
			get {
//				This is slightly safer but less efficient.  Think about wether it should change.
//				return (byte[]) extra.Clone();
		...
		public int AESKeySize {
			get {
				...
				switch (_aesEncryptionStrength) {
					...
					case 3: return 256;
					default: throw new  Exception("Invalid AESEncryptionStrength " + _aesEncryptionStrength);
				}
			}
			set {
				switch (value) {
					...
					default: throw new Exception("AESKeySize must be 0, 128 or 256: " + value);
				}
			}
		}
		...
		private void ProcessAESExtraData(ZipExtraData extraData) {
			...
			if (extraData.Find(0x9901)) {
				...
				extraData.ReadShort();			// Version number (1=AE-1 2=AE-2)
				extraData.ReadShort();		// 2-character vendor ID 0x4541 = "AE"
				extraData.ReadByte();	// encryption strength 1 = 128 2 = 192 3 = 256
